defmodule JesusthroughmaryWeb.Router do
  ...
  import JesusthroughmaryWeb.UserAuth
  ...
  scope "/", JesusthroughmaryWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{JesusthroughmaryWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", JesusthroughmaryWeb do
    ...
    live_session :current_user,
      on_mount: [{JesusthroughmaryWeb.UserAuth, :mount_current_user}] do
